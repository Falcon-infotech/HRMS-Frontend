    ...
    <div className="p-6 bg-white rounded shadow">
      ...
      {loading ? (
        <div className="flex justify-center items-center py-10">
          ...
          {/* <span className="w-6 h-6 border-2 border-gray-300 border-t-blue-500 rounded-full animate-spin inline-block mr-2"></span>
          <span className="text-sm text-gray-500">Loading leave status...</span> */}
        </div>
      ) : (
